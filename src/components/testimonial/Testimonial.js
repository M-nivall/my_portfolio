...
import {  quote, testimonialThree, testimonialFour } from "../../assets";
        ...
        <div className='max-w-6xl max-auto'>
          <Slider {...settings}>
            <div className='w-full'>
              ...
              <div className='w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] t0-[#23272b] p-8 rounded-lg 
              shadow-shadowOne flex flex-col md:flex-row lgl:flex-col gap-8 
              justify-center md:justify-start lgl:justify-center'>
                <img 
                className="h-72 md:w-32 lgl:w-72 rounded-lg object-cover"
              ...
              <div className='w-full lgl:w-[60%] h-full flex flex-col justify-between'>
                ...
                shadow-shadowOne p-4 lgl:p-8 flex flex-col justify-center gap-4 lgl:gap-8'>
                  ...
                  <p className="text-base font-titleFont text-gray-400 font-medium tracking-wide leading-6">
                    Ability to think outside the box and find creative solutions, consistently 
                    delivered high quality work, exceeding expectations and denmonstrating a
            ...
            <div className='w-full'>
              ...
              <div className='w-full lgl:w-[60%] h-full flex flex-col justify-between'>
                ...
                shadow-shadowOne p-4 lgl:p-8 flex flex-col justify-center gap-4 lgl:gap-8'>
                  ...
                  <p className="text-base font-titleFont text-gray-400 font-medium tracking-wide leading-6">
                  Dedicated, reliable and consistently exceeded expectations, denmonstrating reliabilty and adding significant value 
                  to any team. Highly recommended for his exceptional performance...
                  </p>
                </div>
              </div>
              </div>
