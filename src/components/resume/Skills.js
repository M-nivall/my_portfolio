   ...
   <div className="overflow-x-hidden">
    ...
    <div className="overflow-x-hidden">
      ...
      <motion.span
       ...
       transition={{ duration: 0.5, delay: 0.5 }}
      className='w-full h-2 bgOpacity inline-flex rounded-md mt-2'>
        <span className='w-[98%] h-full bg-gradient-to-r from-blue-600 via pink-500 to-red-500 
        rounded-md relative'>
    ...
    <div className="overflow-x-hidden">
      <p className='text-sm uppercase font-medium'>Php: msql</p>
      <motion.span
       initial={{ x: "-100%", opacity: 0 }}
       animate={{ x: 0, opacity: 1 }}
       transition={{ duration: 0.5, delay: 0.5 }}
      className='w-full h-2 bgOpacity inline-flex rounded-md mt-2'>
        <span className='w-[100%] h-full bg-gradient-to-r from-blue-600 via pink-500 to-red-500 
        rounded-md relative'>
          <span className='absolute -top-7 right-0'>100%</span>
        </span>
      </motion.span>
    ...
    <h2 className='text-3xl md:text-4xl font-bold'>Networking Skills</h2>
   </div>
   <div className='mt-14 w-full flex flex-col gap-5'>
   <div className="overflow-x-hidden">
      <p className='text-sm uppercase font-medium'>API Integration</p>
      <motion.span 
       initial={{ x: "-100%", opacity: 0 }}
       animate={{ x: 0, opacity: 1 }}
       transition={{ duration: 0.5, delay: 0.5 }}
    ...
    <div className="overflow-x-hidden">
      <p className='text-sm uppercase font-medium'>Server Administration</p>
      <motion.span
       initial={{ x: "-100%", opacity: 0 }}
       animate={{ x: 0, opacity: 1 }}
       transition={{ duration: 0.5, delay: 0.5 }}
      className='w-full h-2 bgOpacity inline-flex rounded-md mt-2'>
        <span className='w-[85%] h-full bg-gradient-to-r from-blue-600 via pink-500 to-red-500 
        rounded-md relative'>
    ...
    <div className="overflow-x-hidden">
      <p className='text-sm uppercase font-medium'>Performance Optimization</p>
      <motion.span
       initial={{ x: "-100%", opacity: 0 }}
       animate={{ x: 0, opacity: 1 }}
       transition={{ duration: 0.5, delay: 0.5 }}
      className='w-full h-2 bgOpacity inline-flex rounded-md mt-2'>
        <span className='w-[92%] h-full bg-gradient-to-r from-blue-600 via pink-500 to-red-500 
        rounded-md relative'>
    ...
    <div className="overflow-x-hidden">
      <p className='text-sm uppercase font-medium'>Hardware Installation</p>
      <motion.span
       initial={{ x: "-100%", opacity: 0 }}
       animate={{ x: 0, opacity: 1 }}
       transition={{ duration: 0.5, delay: 0.5 }}
